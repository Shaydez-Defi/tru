    ...
    <div className="tru-root">
      <style>{`
        ...
        *{ box-sizing:border-box; }
        ...
        .hero{ position:relative; min-height:calc(100vh - 170px); min-height:calc(100svh - 170px); display:flex; flex-direction:column; align-items:center; justify-content:center;
