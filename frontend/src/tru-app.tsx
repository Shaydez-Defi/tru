    ...
    <div className="tru-root">
      <style>{`
        ...
        *{ box-sizing:border-box; }
        ...
        .hero{ position:relative; min-height:calc(100vh - 194px); min-height:calc(100svh - 194px); display:flex; flex-direction:column; align-items:center; justify-content:center;
